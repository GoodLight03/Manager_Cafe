...
public class JwtUtil {
    private String secret="1234567890123456789012345678901212345678901234567890123456789012";

    public String extractUsername(String tokem){
        return extractClamis(tokem, Claims::getSubject);
    }
